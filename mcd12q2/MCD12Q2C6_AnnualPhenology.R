...
arg_parser$add_argument("-out_dir", type="character", default="/projectnb/modislc/users/mkmoon/LCD_C6/v7/des_sp/pheno") # output directory
arg_parser$add_argument("-out_prefix", type="character", default="MCD12Q2C61") # prefix for output files
arg_parser$add_argument("-data_dir", type="character", default="/projectnb/modislc/users/mkmoon/LCD_C6/v7/des_sp/spline") # input binary splined evi data directory
arg_parser$add_argument("-data_prefix", type="character", default="c61_v7") # prefix of input binary files
...
clusterEvalQ(cl, {source("/projectnb/modislc/users/joshgray/MCD12Q2C6/MCD12Q2C6_AnnualPhenologyFunctions.R")})
