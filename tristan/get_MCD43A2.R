...
if(year==2000){
  ...
  for(i in 55:365){
    ...
    url <- paste('https://e4ftl01.cr.usgs.gov/MOTA/MCD43A2.006/',year,'.',mm,'.',dd,'/',sep='')
    
    system(paste('wget --user=twgreen --password=BUremotesensing1! -l1 -r --no-parent -A "MCD43A2.A',year,d_str,'.',tile,'.006.*.hdf" ',url,sep=''))
